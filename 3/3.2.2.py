...
def encrypt_string():
	"""Encrypts a string provided by the user"""
	...
	list_of_summed_numbers = sum_numbers_from_lists(numbers_from_string, encrypt_key_numbers)
